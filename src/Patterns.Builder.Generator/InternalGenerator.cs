...
";
    ...
    public static CompilationUnitSyntax GenerateNestedBuilder(BuilderToGenerate context, System.Collections.Immutable.ImmutableArray<BuilderToGenerate> builders) => InNamespace(
            context.Namespace,
                        ...
                        Block(
                            SingletonList<StatementSyntax>(
                                ReturnStatement(
                                    ...
                                    .WithArgumentList(
                                        ArgumentList()))))),
                    GenerateBuilder(context, builders),
                ]))));
    ...
    private static ClassDeclarationSyntax GenerateBuilder(BuilderToGenerate context, System.Collections.Immutable.ImmutableArray<BuilderToGenerate> builders)
    {
            ...
            Trivia(
                DocumentationComment(
                    XmlSummaryElement(
                        ...
                        XmlText(" builder.")),
                    XmlText(XmlTextNewLine(NewLine, continueXmlDocumentationComment: false)))))
            .WithMembers([.. CreateMembers(context, builders)]);

        static IEnumerable<MemberDeclarationSyntax> CreateMembers(BuilderToGenerate context, System.Collections.Immutable.ImmutableArray<BuilderToGenerate> builders)
        {
